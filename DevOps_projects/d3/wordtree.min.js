function resize() {
    width = document.documentElement.clientWidth, height = document.documentElement.clientHeight - 50 - 0, heatmap.attr("transform", "translate(" + (width - 20.5) + ",.5)").select("rect.frame").attr("height", height - 1), svg.attr("width", width).attr("height", height), clip.attr("width", width - 30.5).attr("height", height), treeG.call(tree.width(width - 30).height(height - 20)), updateHeatmap(), text.call(textViewer)
}
function processText(e) {
    var t, n = 0, r = 0, i = 0, o = 0, a = text.append("span").text("m"), c = 285 / (a.node() && a.node().offsetWidth || 1);
...
function highlightTokens(e, t) {
    if (e)
        if (e.children && e.children.length)
            t += e.tokens.length, e.children.forEach(function(e) {
                highlightTokens(e, t)
            });
        else {
...
!function() {
    ...
    function t() {
        function e(a) {
            ...
            if (s) {
                ...
                g.enter().append("tspan").text(function(e, t) {
                    ...
                    var n, r = d3.event;
                    r.ctrlKey || r.altKey || r.shiftKey ? (a.call(e.prefix([t.token.token])), n = t.token.token, t.data = b) : (n = f(t.data), o(t.data), e(a)), E.prefix({keyword: n,tree: t.data})
        ...
        return e.tokens = function(t) {
            ...
            for (var n, r = 0, i = _.length; i > r; ++r)
                n = M.call(e, _[r], r), (w.hasOwnProperty(n) ? w[n] : w[n] = []).push(r);
            return e
        }, e.prefix = function(t) {
    ...
    function o(e) {
        for (a(e); e.parent; )
            e.parent._children || (e.parent._children = e.parent.children, e.parent.children = [e], e.parent._count = e.parent.count), e.parent.count = e.count, e = e.parent
    }
    function a(e) {
    ...
    function c(e) {
        var t = [];
        do
            t.unshift(e.index + "-" + e.tokens.length), e = e.parent;
        while (e);
        return t.join("/")
    }
    function l(e) {
